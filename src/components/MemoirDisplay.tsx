...
const MemoirDisplay = ({ data, isLoading }: Props) => {
  return (
    <MemoirContainer>
      ...
      <CardContainer>
        <CardTitle>
          <HeartTwoTone twoToneColor="#f43f5e" style={{ marginRight: "6px" }} />
          회고
        </CardTitle>
      ...
      <CardContainer>
        <CardTitle>
          <SmileTwoTone twoToneColor="#f59e0b" style={{ marginRight: "6px" }} />
          내 감정
        </CardTitle>
      ...
      <CardContainer>
        <CardTitle>
          <SoundTwoTone twoToneColor="#7c3aed" style={{ marginRight: "6px" }} />
          Memoir AI 의 조언
        </CardTitle>
        <CardContent>
